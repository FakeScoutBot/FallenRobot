class Config(object):
    ...
    DATABASE_URL = "postgresql://ghost:sQ1ZMBNvaoAv9H92ViPpOA@thorn-octopus-5107.j77.aws-us-east-1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full"  # A sql database url from elephantsql.com
